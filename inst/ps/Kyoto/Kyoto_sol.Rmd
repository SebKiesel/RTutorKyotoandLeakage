...
libs = c("foreign","dplyr","lfe","stargazer","sandwich","XML","leaflet","regtools","AER","ggplot2","gridExtra","maps") # character vector of all packages you load in the problem set
