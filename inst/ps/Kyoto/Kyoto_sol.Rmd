...
library(yaml)
#library(restorepoint)
setwd("C:/Users/Hirschkopf/Documents/Uni/MasterArbeit/Replicate")
ps.name = "Kyoto"; sol.file = paste0(ps.name,"_sol.Rmd")
libs = c("foreign","dplyr","lfe","stargazer","sandwich","XML","leaflet","regtools","AER","ggplot2","gridExtra","maps","rworldmap") # character vector of all packages you load in the problem set
