...
libs = c("foreign","dplyr","lfe","stargazer","AER","sandwich","leaflet","regtools","ggplot2","gridExtra","rworldmap") # character vector of all packages you load in the problem set
